...
namespace IceCity.Services
{
    public class ServiceOne
    {
        ...
        public double TotalWorkingHours(List<double> workingHours)
        {
            return workingHours.Sum();
        }
        public double MedianHeaterValue(List<double> heaterValues)
        {
            return heaterValues.Sum() / heaterValues.Count();
        }
        public double MonthlyAverageCost(List<double> workingHours)
        {
            workingHours.Sort();
